...
public class SaleGoodsServiceImpl implements SaleGoodsService {
    ...
    public String saleGoodsSer(String userName, String saleInfo, String vipPhone, Boolean isUseVipBalance) {
        ...
        if (isUseVipBalance && vipPhone != null && !vipPhone.equals("")) {
        ...
        try {
            ...
            if (vipListMapper.getVipByPhoneSql(userName, vipPhone) != null) {
                Vip_Info thisVipSale = vipListMapper.getVipByPhoneSql(userName, vipPhone);
                saleGoodsMapper.saleGoodsWithVip(userName, saleId, saleInfo, saleDate,thisVipSale.getVip_name()+" "+thisVipSale.getVip_phone());
            } else {
